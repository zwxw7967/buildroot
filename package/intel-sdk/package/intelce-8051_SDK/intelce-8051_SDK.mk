...
#
################################################################################
INTELCE_8051_SDK_VERSION = ${INTEL_SDK_VERSION}
INTELCE_8051_SDK_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_8051_SDK_SITE_METHOD = local
INTELCE_8051_SDK_LICENSE = PROPRIETARY
INTELCE_8051_SDK_REDISTRIBUTE = NO
INTELCE_8051_SDK_DEPENDENCIES = intel-sdk
...
define INTELCE_8051_SDK_BUILD_CMDS
    ...
    ${INTELCE_8051_SDK_BUILD_ENV} ${INTELSDK-BUILD} 8051_SDK
endef

define INTELCE_8051_SDK_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_8051_SDK_DIR}/build_i686/staging_dir) 
endef

define INTELCE_8051_SDK_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_8051_SDK_DIR}/project_build_i686/IntelCE/root)
endef
