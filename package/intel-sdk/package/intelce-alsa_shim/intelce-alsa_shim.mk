...
#
################################################################################
INTELCE_ALSA_SHIM_VERSION = ${INTEL_SDK_VERSION}
INTELCE_ALSA_SHIM_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_ALSA_SHIM_SITE_METHOD = local
INTELCE_ALSA_SHIM_LICENSE = PROPRIETARY
INTELCE_ALSA_SHIM_REDISTRIBUTE = NO
INTELCE_ALSA_SHIM_DEPENDENCIES = intel-sdk intelce-system_utils intelce-auto_eas intelce-audio intelce-auto_eas intelce-osal intelce-sven linux intelce-core intelce-SMD_Common intelce-api intelce-alsa
...
define INTELCE_ALSA_SHIM_BUILD_CMDS
    ...
    ${INTELCE_ALSA_SHIM_BUILD_ENV} ${INTELSDK-BUILD} alsa_shim
endef

define INTELCE_ALSA_SHIM_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_ALSA_SHIM_DIR}/build_i686/staging_dir) 
endef

define INTELCE_ALSA_SHIM_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_ALSA_SHIM_DIR}/project_build_i686/IntelCE/root)
endef
