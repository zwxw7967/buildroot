...
#
################################################################################
INTELCE_AUTO_EAS_VERSION = ${INTEL_SDK_VERSION}
INTELCE_AUTO_EAS_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_AUTO_EAS_SITE_METHOD = local
INTELCE_AUTO_EAS_LICENSE = PROPRIETARY
INTELCE_AUTO_EAS_REDISTRIBUTE = NO
INTELCE_AUTO_EAS_DEPENDENCIES = intel-sdk intelce-SMD_Common linux
...
define INTELCE_AUTO_EAS_BUILD_CMDS
    ...
    ${INTELCE_AUTO_EAS_BUILD_ENV} ${INTELSDK-BUILD} auto_eas
endef

define INTELCE_AUTO_EAS_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_AUTO_EAS_DIR}/build_i686/staging_dir) 
endef

define INTELCE_AUTO_EAS_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_AUTO_EAS_DIR}/project_build_i686/IntelCE/root)
endef
