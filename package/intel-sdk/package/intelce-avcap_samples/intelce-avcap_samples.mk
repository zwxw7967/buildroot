...
#
################################################################################
INTELCE_AVCAP_SAMPLES_VERSION = ${INTEL_SDK_VERSION}
INTELCE_AVCAP_SAMPLES_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_AVCAP_SAMPLES_SITE_METHOD = local
INTELCE_AVCAP_SAMPLES_LICENSE = PROPRIETARY
INTELCE_AVCAP_SAMPLES_REDISTRIBUTE = NO
INTELCE_AVCAP_SAMPLES_DEPENDENCIES = intel-sdk intelce-avcap intelce-display intelce-bufmon intelce-common intelce-vidrend intelce-vidpproc intelce-viddec intelce-audio intelce-core intelce-demux intelce-clock intelce-clock_recovery intelce-smd_tools intelce-smd_sample_apps
...
define INTELCE_AVCAP_SAMPLES_BUILD_CMDS
    ...
    ${INTELCE_AVCAP_SAMPLES_BUILD_ENV} ${INTELSDK-BUILD} avcap_samples
endef

define INTELCE_AVCAP_SAMPLES_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_AVCAP_SAMPLES_DIR}/build_i686/staging_dir) 
endef

define INTELCE_AVCAP_SAMPLES_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_AVCAP_SAMPLES_DIR}/project_build_i686/IntelCE/root)
endef
