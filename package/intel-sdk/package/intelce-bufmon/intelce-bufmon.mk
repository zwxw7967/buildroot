...
#
################################################################################
INTELCE_BUFMON_VERSION = ${INTEL_SDK_VERSION}
INTELCE_BUFMON_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_BUFMON_SITE_METHOD = local
INTELCE_BUFMON_LICENSE = PROPRIETARY
INTELCE_BUFMON_REDISTRIBUTE = NO
INTELCE_BUFMON_DEPENDENCIES = intel-sdk intelce-api intelce-core intelce-pal intelce-osal intelce-auto_eas intelce-sven intelce-htuple intelce-system_utils intelce-platform_config intelce-common intelce-smd_tools linux intelce-SMD_Common intelce-clock_recovery
...
define INTELCE_BUFMON_BUILD_CMDS
    ...
    ${INTELCE_BUFMON_BUILD_ENV} ${INTELSDK-BUILD} bufmon
endef

define INTELCE_BUFMON_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_BUFMON_DIR}/build_i686/staging_dir) 
endef

define INTELCE_BUFMON_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_BUFMON_DIR}/project_build_i686/IntelCE/root)
endef
