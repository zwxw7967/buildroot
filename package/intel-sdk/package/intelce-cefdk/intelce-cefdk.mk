...
#
################################################################################
INTELCE_CEFDK_VERSION = ${INTEL_SDK_VERSION}
INTELCE_CEFDK_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_CEFDK_SITE_METHOD = local
INTELCE_CEFDK_LICENSE = PROPRIETARY
INTELCE_CEFDK_REDISTRIBUTE = NO
INTELCE_CEFDK_DEPENDENCIES = intel-sdk intelce-flash_encryption_signing_tools
...
define INTELCE_CEFDK_BUILD_CMDS
    ...
    ${INTELCE_CEFDK_BUILD_ENV} ${INTELSDK-BUILD} cefdk
endef

define INTELCE_CEFDK_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_CEFDK_DIR}/build_i686/staging_dir) 
endef

define INTELCE_CEFDK_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_CEFDK_DIR}/project_build_i686/IntelCE/root)
endef
