...
#
################################################################################
INTELCE_CLOCK_CONTROL_VERSION = ${INTEL_SDK_VERSION}
INTELCE_CLOCK_CONTROL_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_CLOCK_CONTROL_SITE_METHOD = local
INTELCE_CLOCK_CONTROL_LICENSE = PROPRIETARY
INTELCE_CLOCK_CONTROL_REDISTRIBUTE = NO
INTELCE_CLOCK_CONTROL_DEPENDENCIES = intel-sdk intelce-sven linux intelce-idl intelce-osal intelce-pal intelce-platform_config
...
define INTELCE_CLOCK_CONTROL_BUILD_CMDS
    ...
    ${INTELCE_CLOCK_CONTROL_BUILD_ENV} ${INTELSDK-BUILD} clock_control
endef

define INTELCE_CLOCK_CONTROL_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_CLOCK_CONTROL_DIR}/build_i686/staging_dir) 
endef

define INTELCE_CLOCK_CONTROL_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_CLOCK_CONTROL_DIR}/project_build_i686/IntelCE/root)
endef
