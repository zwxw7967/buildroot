...
#
################################################################################
INTELCE_CLOCK_RECOVERY_VERSION = ${INTEL_SDK_VERSION}
INTELCE_CLOCK_RECOVERY_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_CLOCK_RECOVERY_SITE_METHOD = local
INTELCE_CLOCK_RECOVERY_LICENSE = PROPRIETARY
INTELCE_CLOCK_RECOVERY_REDISTRIBUTE = NO
INTELCE_CLOCK_RECOVERY_DEPENDENCIES = intel-sdk intelce-pal intelce-auto_eas intelce-osal intelce-htuple intelce-smd_tools intelce-sven linux intelce-core intelce-SMD_Common intelce-api intelce-platform_config intelce-clock
...
define INTELCE_CLOCK_RECOVERY_BUILD_CMDS
    ...
    ${INTELCE_CLOCK_RECOVERY_BUILD_ENV} ${INTELSDK-BUILD} clock_recovery
endef

define INTELCE_CLOCK_RECOVERY_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_CLOCK_RECOVERY_DIR}/build_i686/staging_dir) 
endef

define INTELCE_CLOCK_RECOVERY_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_CLOCK_RECOVERY_DIR}/project_build_i686/IntelCE/root)
endef
