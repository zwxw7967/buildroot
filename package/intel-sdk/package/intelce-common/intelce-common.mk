...
#
################################################################################
INTELCE_COMMON_VERSION = ${INTEL_SDK_VERSION}
INTELCE_COMMON_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_COMMON_SITE_METHOD = local
INTELCE_COMMON_LICENSE = PROPRIETARY
INTELCE_COMMON_REDISTRIBUTE = NO
INTELCE_COMMON_DEPENDENCIES = intel-sdk intelce-pal intelce-auto_eas intelce-clock intelce-osal intelce-htuple intelce-smd_tools intelce-sven linux intelce-core intelce-api intelce-SMD_Common
...
define INTELCE_COMMON_BUILD_CMDS
    ...
    ${INTELCE_COMMON_BUILD_ENV} ${INTELSDK-BUILD} common
endef

define INTELCE_COMMON_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_COMMON_DIR}/build_i686/staging_dir) 
endef

define INTELCE_COMMON_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_COMMON_DIR}/project_build_i686/IntelCE/root)
endef
