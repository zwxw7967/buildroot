...
#
################################################################################
INTELCE_CONFIG_VERSION = ${INTEL_SDK_VERSION}
INTELCE_CONFIG_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_CONFIG_SITE_METHOD = local
INTELCE_CONFIG_LICENSE = PROPRIETARY
INTELCE_CONFIG_REDISTRIBUTE = NO
INTELCE_CONFIG_DEPENDENCIES = intel-sdk
...
define INTELCE_CONFIG_BUILD_CMDS
    ...
    ${INTELCE_CONFIG_BUILD_ENV} ${INTELSDK-BUILD} config
endef

define INTELCE_CONFIG_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_CONFIG_DIR}/build_i686/staging_dir) 
endef

define INTELCE_CONFIG_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_CONFIG_DIR}/project_build_i686/IntelCE/root)
endef
