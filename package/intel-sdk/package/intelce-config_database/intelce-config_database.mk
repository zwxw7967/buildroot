...
#
################################################################################
INTELCE_CONFIG_DATABASE_VERSION = ${INTEL_SDK_VERSION}
INTELCE_CONFIG_DATABASE_SITE = ${INTEL_SDK_DIR}/empty
...
INTELCE_CONFIG_DATABASE_DEPENDENCIES = intel-sdk
...
define INTELCE_CONFIG_DATABASE_BUILD_CMDS
    ...
    ${INTELCE_CONFIG_DATABASE_BUILD_ENV} ${INTELSDK-BUILD} config_database
endef

define INTELCE_CONFIG_DATABASE_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_CONFIG_DATABASE_DIR}/build_i686/staging_dir) 
endef

define INTELCE_CONFIG_DATABASE_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_CONFIG_DATABASE_DIR}/project_build_i686/IntelCE/root)
endef
