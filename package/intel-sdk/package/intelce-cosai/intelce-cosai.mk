...
#
################################################################################
INTELCE_COSAI_VERSION = ${INTEL_SDK_VERSION}
INTELCE_COSAI_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_COSAI_SITE_METHOD = local
INTELCE_COSAI_LICENSE = PROPRIETARY
INTELCE_COSAI_REDISTRIBUTE = NO
INTELCE_COSAI_DEPENDENCIES = intel-sdk linux
...
define INTELCE_COSAI_BUILD_CMDS
    ...
    ${INTELCE_COSAI_BUILD_ENV} ${INTELSDK-BUILD} cosai
endef

define INTELCE_COSAI_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_COSAI_DIR}/build_i686/staging_dir) 
endef

define INTELCE_COSAI_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_COSAI_DIR}/project_build_i686/IntelCE/root)
endef
