...
#
################################################################################
INTELCE_DEVMEM_VERSION = ${INTEL_SDK_VERSION}
INTELCE_DEVMEM_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_DEVMEM_SITE_METHOD = local
INTELCE_DEVMEM_LICENSE = PROPRIETARY
INTELCE_DEVMEM_REDISTRIBUTE = NO
INTELCE_DEVMEM_DEPENDENCIES = intel-sdk linux intelce-platform_config
...
define INTELCE_DEVMEM_BUILD_CMDS
    ...
    ${INTELCE_DEVMEM_BUILD_ENV} ${INTELSDK-BUILD} devmem
endef

define INTELCE_DEVMEM_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_DEVMEM_DIR}/build_i686/staging_dir) 
endef

define INTELCE_DEVMEM_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_DEVMEM_DIR}/project_build_i686/IntelCE/root)
endef
