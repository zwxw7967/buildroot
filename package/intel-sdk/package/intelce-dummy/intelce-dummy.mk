...
#
################################################################################
INTELCE_DUMMY_VERSION = ${INTEL_SDK_VERSION}
INTELCE_DUMMY_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_DUMMY_SITE_METHOD = local
INTELCE_DUMMY_LICENSE = PROPRIETARY
INTELCE_DUMMY_REDISTRIBUTE = NO
INTELCE_DUMMY_DEPENDENCIES = intel-sdk
...
define INTELCE_DUMMY_BUILD_CMDS
    ...
    ${INTELCE_DUMMY_BUILD_ENV} ${INTELSDK-BUILD} dummy
endef

define INTELCE_DUMMY_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_DUMMY_DIR}/build_i686/staging_dir) 
endef

define INTELCE_DUMMY_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_DUMMY_DIR}/project_build_i686/IntelCE/root)
endef
