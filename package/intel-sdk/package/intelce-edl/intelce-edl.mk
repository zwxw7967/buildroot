...
#
################################################################################
INTELCE_EDL_VERSION = ${INTEL_SDK_VERSION}
INTELCE_EDL_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_EDL_SITE_METHOD = local
INTELCE_EDL_LICENSE = PROPRIETARY
INTELCE_EDL_REDISTRIBUTE = NO
INTELCE_EDL_DEPENDENCIES = intel-sdk linux intelce-osal intelce-idl intelce-audio intelce-SMD_Common intelce-smd_tools intelce-pal intelce-flash_appdata intelce-system_utils
...
define INTELCE_EDL_BUILD_CMDS
    ...
    ${INTELCE_EDL_BUILD_ENV} ${INTELSDK-BUILD} edl
endef

define INTELCE_EDL_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_EDL_DIR}/build_i686/staging_dir) 
endef

define INTELCE_EDL_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_EDL_DIR}/project_build_i686/IntelCE/root)
endef
