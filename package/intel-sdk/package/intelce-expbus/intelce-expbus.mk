...
#
################################################################################
INTELCE_EXPBUS_VERSION = ${INTEL_SDK_VERSION}
INTELCE_EXPBUS_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_EXPBUS_SITE_METHOD = local
INTELCE_EXPBUS_LICENSE = PROPRIETARY
INTELCE_EXPBUS_REDISTRIBUTE = NO
INTELCE_EXPBUS_DEPENDENCIES = intel-sdk linux
...
define INTELCE_EXPBUS_BUILD_CMDS
    ...
    ${INTELCE_EXPBUS_BUILD_ENV} ${INTELSDK-BUILD} expbus
endef

define INTELCE_EXPBUS_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_EXPBUS_DIR}/build_i686/staging_dir) 
endef

define INTELCE_EXPBUS_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_EXPBUS_DIR}/project_build_i686/IntelCE/root)
endef
