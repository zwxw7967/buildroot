...
#
################################################################################
INTELCE_FAKEROOT_VERSION = ${INTEL_SDK_VERSION}
INTELCE_FAKEROOT_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_FAKEROOT_SITE_METHOD = local
INTELCE_FAKEROOT_LICENSE = PROPRIETARY
INTELCE_FAKEROOT_REDISTRIBUTE = NO
INTELCE_FAKEROOT_DEPENDENCIES = intel-sdk
...
define INTELCE_FAKEROOT_BUILD_CMDS
    ...
    ${INTELCE_FAKEROOT_BUILD_ENV} ${INTELSDK-BUILD} fakeroot
endef

define INTELCE_FAKEROOT_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_FAKEROOT_DIR}/build_i686/staging_dir) 
endef

define INTELCE_FAKEROOT_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_FAKEROOT_DIR}/project_build_i686/IntelCE/root)
endef
