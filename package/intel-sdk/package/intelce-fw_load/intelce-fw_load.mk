...
#
################################################################################
INTELCE_FW_LOAD_VERSION = ${INTEL_SDK_VERSION}
INTELCE_FW_LOAD_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_FW_LOAD_SITE_METHOD = local
INTELCE_FW_LOAD_LICENSE = PROPRIETARY
INTELCE_FW_LOAD_REDISTRIBUTE = NO
INTELCE_FW_LOAD_DEPENDENCIES = intel-sdk intelce-system_utils intelce-pal intelce-auto_eas intelce-osal intelce-htuple intelce-common intelce-smd_tools intelce-sven linux intelce-core intelce-api intelce-sec
...
define INTELCE_FW_LOAD_BUILD_CMDS
    ...
    ${INTELCE_FW_LOAD_BUILD_ENV} ${INTELSDK-BUILD} fw_load
endef

define INTELCE_FW_LOAD_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_FW_LOAD_DIR}/build_i686/staging_dir) 
endef

define INTELCE_FW_LOAD_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_FW_LOAD_DIR}/project_build_i686/IntelCE/root)
endef
