...
#
################################################################################
INTELCE_GNUCONFIG_VERSION = ${INTEL_SDK_VERSION}
INTELCE_GNUCONFIG_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_GNUCONFIG_SITE_METHOD = local
INTELCE_GNUCONFIG_LICENSE = PROPRIETARY
INTELCE_GNUCONFIG_REDISTRIBUTE = NO
INTELCE_GNUCONFIG_DEPENDENCIES = intel-sdk
...
define INTELCE_GNUCONFIG_BUILD_CMDS
    ...
    ${INTELCE_GNUCONFIG_BUILD_ENV} ${INTELSDK-BUILD} gnuconfig
endef

define INTELCE_GNUCONFIG_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_GNUCONFIG_DIR}/build_i686/staging_dir) 
endef

define INTELCE_GNUCONFIG_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_GNUCONFIG_DIR}/project_build_i686/IntelCE/root)
endef
