...
#
################################################################################
INTELCE_GPIO_VERSION = ${INTEL_SDK_VERSION}
INTELCE_GPIO_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_GPIO_SITE_METHOD = local
INTELCE_GPIO_LICENSE = PROPRIETARY
INTELCE_GPIO_REDISTRIBUTE = NO
INTELCE_GPIO_DEPENDENCIES = intel-sdk linux
...
define INTELCE_GPIO_BUILD_CMDS
    ...
    ${INTELCE_GPIO_BUILD_ENV} ${INTELSDK-BUILD} gpio
endef

define INTELCE_GPIO_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_GPIO_DIR}/build_i686/staging_dir) 
endef

define INTELCE_GPIO_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_GPIO_DIR}/project_build_i686/IntelCE/root)
endef
