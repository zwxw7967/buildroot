...
#
################################################################################
INTELCE_GRAPHICS_APPS_VERSION = ${INTEL_SDK_VERSION}
INTELCE_GRAPHICS_APPS_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_GRAPHICS_APPS_SITE_METHOD = local
INTELCE_GRAPHICS_APPS_LICENSE = PROPRIETARY
INTELCE_GRAPHICS_APPS_REDISTRIBUTE = NO
INTELCE_GRAPHICS_APPS_DEPENDENCIES = intel-sdk intelce-graphics intelce-osal intelce-pal intelce-display intelce-jpeg intelce-smd_sample_apps
...
define INTELCE_GRAPHICS_APPS_BUILD_CMDS
    ...
    ${INTELCE_GRAPHICS_APPS_BUILD_ENV} ${INTELSDK-BUILD} graphics_apps
endef

define INTELCE_GRAPHICS_APPS_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_GRAPHICS_APPS_DIR}/build_i686/staging_dir) 
endef

define INTELCE_GRAPHICS_APPS_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_GRAPHICS_APPS_DIR}/project_build_i686/IntelCE/root)
endef
