...
#
################################################################################
INTELCE_HTUPLE_VERSION = ${INTEL_SDK_VERSION}
INTELCE_HTUPLE_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_HTUPLE_SITE_METHOD = local
INTELCE_HTUPLE_LICENSE = PROPRIETARY
INTELCE_HTUPLE_REDISTRIBUTE = NO
INTELCE_HTUPLE_DEPENDENCIES = intel-sdk linux intelce-SMD_Common
...
define INTELCE_HTUPLE_BUILD_CMDS
    ...
    ${INTELCE_HTUPLE_BUILD_ENV} ${INTELSDK-BUILD} htuple
endef

define INTELCE_HTUPLE_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_HTUPLE_DIR}/build_i686/staging_dir) 
endef

define INTELCE_HTUPLE_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_HTUPLE_DIR}/project_build_i686/IntelCE/root)
endef
