...
define INTELCE_IDTS_CORE_BUILD_CMDS
    ...
    ${INTELCE_IDTS_CORE_BUILD_ENV} ${INTELSDK-BUILD} idts_core
endef

define INTELCE_IDTS_CORE_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_IDTS_CORE_DIR}/build_i686/staging_dir) 
endef

define INTELCE_IDTS_CORE_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_IDTS_CORE_DIR}/project_build_i686/IntelCE/root)
endef
