...
#
################################################################################
INTELCE_IDTS_SECURITY_VERSION = ${INTEL_SDK_VERSION}
INTELCE_IDTS_SECURITY_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_IDTS_SECURITY_SITE_METHOD = local
INTELCE_IDTS_SECURITY_LICENSE = PROPRIETARY
INTELCE_IDTS_SECURITY_REDISTRIBUTE = NO
INTELCE_IDTS_SECURITY_DEPENDENCIES = intel-sdk intelce-pal intelce-osal intelce-nand_config intelce-flash_appdata intelce-sec openssl intelce-idts_common intelce-idtsal
...
define INTELCE_IDTS_SECURITY_BUILD_CMDS
    ...
    ${INTELCE_IDTS_SECURITY_BUILD_ENV} ${INTELSDK-BUILD} idts_security
endef

define INTELCE_IDTS_SECURITY_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_IDTS_SECURITY_DIR}/build_i686/staging_dir) 
endef

define INTELCE_IDTS_SECURITY_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_IDTS_SECURITY_DIR}/project_build_i686/IntelCE/root)
endef
