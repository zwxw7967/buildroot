...
#
################################################################################
INTELCE_IDTSAL_VERSION = ${INTEL_SDK_VERSION}
INTELCE_IDTSAL_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_IDTSAL_SITE_METHOD = local
INTELCE_IDTSAL_LICENSE = PROPRIETARY
INTELCE_IDTSAL_REDISTRIBUTE = NO
INTELCE_IDTSAL_DEPENDENCIES = intel-sdk linux
...
define INTELCE_IDTSAL_BUILD_CMDS
    ...
    ${INTELCE_IDTSAL_BUILD_ENV} ${INTELSDK-BUILD} idtsal
endef

define INTELCE_IDTSAL_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_IDTSAL_DIR}/build_i686/staging_dir) 
endef

define INTELCE_IDTSAL_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_IDTSAL_DIR}/project_build_i686/IntelCE/root)
endef
