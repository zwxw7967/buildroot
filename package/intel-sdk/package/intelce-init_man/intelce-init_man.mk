...
#
################################################################################
INTELCE_INIT_MAN_VERSION = ${INTEL_SDK_VERSION}
INTELCE_INIT_MAN_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_INIT_MAN_SITE_METHOD = local
INTELCE_INIT_MAN_LICENSE = PROPRIETARY
INTELCE_INIT_MAN_REDISTRIBUTE = NO
INTELCE_INIT_MAN_DEPENDENCIES = intel-sdk
...
define INTELCE_INIT_MAN_BUILD_CMDS
    ...
    ${INTELCE_INIT_MAN_BUILD_ENV} ${INTELSDK-BUILD} init_man
endef

define INTELCE_INIT_MAN_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_INIT_MAN_DIR}/build_i686/staging_dir) 
endef

define INTELCE_INIT_MAN_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_INIT_MAN_DIR}/project_build_i686/IntelCE/root)
endef
