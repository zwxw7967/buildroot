...
#
################################################################################
INTELCE_INTEL_CE_PM_VERSION = ${INTEL_SDK_VERSION}
INTELCE_INTEL_CE_PM_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_INTEL_CE_PM_SITE_METHOD = local
INTELCE_INTEL_CE_PM_LICENSE = PROPRIETARY
INTELCE_INTEL_CE_PM_REDISTRIBUTE = NO
INTELCE_INTEL_CE_PM_DEPENDENCIES = intel-sdk linux intelce-pal intelce-osal intelce-clock_control intelce-system_utils intelce-8051_SDK intelce-iosf
...
define INTELCE_INTEL_CE_PM_BUILD_CMDS
    ...
    ${INTELCE_INTEL_CE_PM_BUILD_ENV} ${INTELSDK-BUILD} intel_ce_pm
endef

define INTELCE_INTEL_CE_PM_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_INTEL_CE_PM_DIR}/build_i686/staging_dir) 
endef

define INTELCE_INTEL_CE_PM_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_INTEL_CE_PM_DIR}/project_build_i686/IntelCE/root)
endef
