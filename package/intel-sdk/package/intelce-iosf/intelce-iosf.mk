...
#
################################################################################
INTELCE_IOSF_VERSION = ${INTEL_SDK_VERSION}
INTELCE_IOSF_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_IOSF_SITE_METHOD = local
INTELCE_IOSF_LICENSE = PROPRIETARY
INTELCE_IOSF_REDISTRIBUTE = NO
INTELCE_IOSF_DEPENDENCIES = intel-sdk linux
...
define INTELCE_IOSF_BUILD_CMDS
    ...
    ${INTELCE_IOSF_BUILD_ENV} ${INTELSDK-BUILD} iosf
endef

define INTELCE_IOSF_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_IOSF_DIR}/build_i686/staging_dir) 
endef

define INTELCE_IOSF_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_IOSF_DIR}/project_build_i686/IntelCE/root)
endef
