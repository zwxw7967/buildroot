...
#
################################################################################
INTELCE_KEYREFRESH_VERSION = ${INTEL_SDK_VERSION}
INTELCE_KEYREFRESH_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_KEYREFRESH_SITE_METHOD = local
INTELCE_KEYREFRESH_LICENSE = PROPRIETARY
INTELCE_KEYREFRESH_REDISTRIBUTE = NO
INTELCE_KEYREFRESH_DEPENDENCIES = intel-sdk intelce-sec
...
define INTELCE_KEYREFRESH_BUILD_CMDS
    ...
    ${INTELCE_KEYREFRESH_BUILD_ENV} ${INTELSDK-BUILD} keyrefresh
endef

define INTELCE_KEYREFRESH_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_KEYREFRESH_DIR}/build_i686/staging_dir) 
endef

define INTELCE_KEYREFRESH_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_KEYREFRESH_DIR}/project_build_i686/IntelCE/root)
endef
