...
#
################################################################################
INTELCE_MFHLIB_VERSION = ${INTEL_SDK_VERSION}
INTELCE_MFHLIB_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_MFHLIB_SITE_METHOD = local
INTELCE_MFHLIB_LICENSE = PROPRIETARY
INTELCE_MFHLIB_REDISTRIBUTE = NO
INTELCE_MFHLIB_DEPENDENCIES = intel-sdk linux intelce-osal intelce-pal intelce-nand_config intelce-flashtool openssl intelce-idtsal
...
define INTELCE_MFHLIB_BUILD_CMDS
    ...
    ${INTELCE_MFHLIB_BUILD_ENV} ${INTELSDK-BUILD} mfhlib
endef

define INTELCE_MFHLIB_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_MFHLIB_DIR}/build_i686/staging_dir) 
endef

define INTELCE_MFHLIB_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_MFHLIB_DIR}/project_build_i686/IntelCE/root)
endef
