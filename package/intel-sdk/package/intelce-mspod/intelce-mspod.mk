...
#
################################################################################
INTELCE_MSPOD_VERSION = ${INTEL_SDK_VERSION}
INTELCE_MSPOD_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_MSPOD_SITE_METHOD = local
INTELCE_MSPOD_LICENSE = PROPRIETARY
INTELCE_MSPOD_REDISTRIBUTE = NO
INTELCE_MSPOD_DEPENDENCIES = intel-sdk linux intelce-auto_eas intelce-osal intelce-idl intelce-flash_appdata intelce-sven intelce-core
...
define INTELCE_MSPOD_BUILD_CMDS
    ...
    ${INTELCE_MSPOD_BUILD_ENV} ${INTELSDK-BUILD} mspod
endef

define INTELCE_MSPOD_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_MSPOD_DIR}/build_i686/staging_dir) 
endef

define INTELCE_MSPOD_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_MSPOD_DIR}/project_build_i686/IntelCE/root)
endef
