...
#
################################################################################
INTELCE_NSPRPUB_MW_DEP_VERSION = ${INTEL_SDK_VERSION}
INTELCE_NSPRPUB_MW_DEP_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_NSPRPUB_MW_DEP_SITE_METHOD = local
INTELCE_NSPRPUB_MW_DEP_LICENSE = PROPRIETARY
INTELCE_NSPRPUB_MW_DEP_REDISTRIBUTE = NO
INTELCE_NSPRPUB_MW_DEP_DEPENDENCIES = intel-sdk intelce-nspr
...
define INTELCE_NSPRPUB_MW_DEP_BUILD_CMDS
    ...
    ${INTELCE_NSPRPUB_MW_DEP_BUILD_ENV} ${INTELSDK-BUILD} nsprpub_mw_dep
endef

define INTELCE_NSPRPUB_MW_DEP_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_NSPRPUB_MW_DEP_DIR}/build_i686/staging_dir) 
endef

define INTELCE_NSPRPUB_MW_DEP_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_NSPRPUB_MW_DEP_DIR}/project_build_i686/IntelCE/root)
endef
