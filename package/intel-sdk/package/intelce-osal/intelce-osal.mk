...
#
################################################################################
INTELCE_OSAL_VERSION = ${INTEL_SDK_VERSION}
INTELCE_OSAL_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_OSAL_SITE_METHOD = local
INTELCE_OSAL_LICENSE = PROPRIETARY
INTELCE_OSAL_REDISTRIBUTE = NO
INTELCE_OSAL_DEPENDENCIES = intel-sdk linux
...
define INTELCE_OSAL_BUILD_CMDS
    ...
    ${INTELCE_OSAL_BUILD_ENV} ${INTELSDK-BUILD} osal
endef

define INTELCE_OSAL_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_OSAL_DIR}/build_i686/staging_dir) 
endef

define INTELCE_OSAL_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_OSAL_DIR}/project_build_i686/IntelCE/root)
endef
