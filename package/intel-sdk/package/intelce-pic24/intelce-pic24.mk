...
#
################################################################################
INTELCE_PIC24_VERSION = ${INTEL_SDK_VERSION}
INTELCE_PIC24_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_PIC24_SITE_METHOD = local
INTELCE_PIC24_LICENSE = PROPRIETARY
INTELCE_PIC24_REDISTRIBUTE = NO
INTELCE_PIC24_DEPENDENCIES = intel-sdk
...
define INTELCE_PIC24_BUILD_CMDS
    ...
    ${INTELCE_PIC24_BUILD_ENV} ${INTELSDK-BUILD} pic24
endef

define INTELCE_PIC24_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_PIC24_DIR}/build_i686/staging_dir) 
endef

define INTELCE_PIC24_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_PIC24_DIR}/project_build_i686/IntelCE/root)
endef
