...
#
################################################################################
INTELCE_PWM_VERSION = ${INTEL_SDK_VERSION}
INTELCE_PWM_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_PWM_SITE_METHOD = local
INTELCE_PWM_LICENSE = PROPRIETARY
INTELCE_PWM_REDISTRIBUTE = NO
INTELCE_PWM_DEPENDENCIES = intel-sdk linux
...
define INTELCE_PWM_BUILD_CMDS
    ...
    ${INTELCE_PWM_BUILD_ENV} ${INTELSDK-BUILD} pwm
endef

define INTELCE_PWM_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_PWM_DIR}/build_i686/staging_dir) 
endef

define INTELCE_PWM_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_PWM_DIR}/project_build_i686/IntelCE/root)
endef
