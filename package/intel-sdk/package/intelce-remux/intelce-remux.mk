...
#
################################################################################
INTELCE_REMUX_VERSION = ${INTEL_SDK_VERSION}
INTELCE_REMUX_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_REMUX_SITE_METHOD = local
INTELCE_REMUX_LICENSE = PROPRIETARY
INTELCE_REMUX_REDISTRIBUTE = NO
INTELCE_REMUX_DEPENDENCIES = intel-sdk intelce-api intelce-core intelce-pal intelce-osal intelce-auto_eas intelce-sven intelce-htuple intelce-system_utils intelce-platform_config intelce-common intelce-smd_tools linux intelce-SMD_Common
...
define INTELCE_REMUX_BUILD_CMDS
    ...
    ${INTELCE_REMUX_BUILD_ENV} ${INTELSDK-BUILD} remux
endef

define INTELCE_REMUX_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_REMUX_DIR}/build_i686/staging_dir) 
endef

define INTELCE_REMUX_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_REMUX_DIR}/project_build_i686/IntelCE/root)
endef
