...
#
################################################################################
INTELCE_SEC_FW_VERSION = ${INTEL_SDK_VERSION}
INTELCE_SEC_FW_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_SEC_FW_SITE_METHOD = local
INTELCE_SEC_FW_LICENSE = PROPRIETARY
INTELCE_SEC_FW_REDISTRIBUTE = NO
INTELCE_SEC_FW_DEPENDENCIES = intel-sdk intelce-sec intelce-flash_appdata intelce-osal intelce-pal intelce-expat intelce-config_database
...
define INTELCE_SEC_FW_BUILD_CMDS
    ...
    ${INTELCE_SEC_FW_BUILD_ENV} ${INTELSDK-BUILD} sec_fw
endef

define INTELCE_SEC_FW_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_SEC_FW_DIR}/build_i686/staging_dir) 
endef

define INTELCE_SEC_FW_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_SEC_FW_DIR}/project_build_i686/IntelCE/root)
endef
