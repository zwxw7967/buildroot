...
#
################################################################################
INTELCE_SED_VERSION = ${INTEL_SDK_VERSION}
INTELCE_SED_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_SED_SITE_METHOD = local
INTELCE_SED_LICENSE = PROPRIETARY
INTELCE_SED_REDISTRIBUTE = NO
INTELCE_SED_DEPENDENCIES = intel-sdk
...
define INTELCE_SED_BUILD_CMDS
    ...
    ${INTELCE_SED_BUILD_ENV} ${INTELSDK-BUILD} sed
endef

define INTELCE_SED_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_SED_DIR}/build_i686/staging_dir) 
endef

define INTELCE_SED_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_SED_DIR}/project_build_i686/IntelCE/root)
endef
