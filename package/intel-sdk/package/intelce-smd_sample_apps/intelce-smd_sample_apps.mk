...
#
################################################################################
INTELCE_SMD_SAMPLE_APPS_VERSION = ${INTEL_SDK_VERSION}
INTELCE_SMD_SAMPLE_APPS_SITE = ${INTEL_SDK_DIR}/empty
...
INTELCE_SMD_SAMPLE_APPS_DEPENDENCIES = intel-sdk intelce-pal intelce-auto_eas intelce-osal intelce-htuple intelce-smd_tools intelce-sven linux intelce-SMD_Common intelce-platform_config intelce-api intelce-core intelce-audio intelce-audio_fw intelce-clock intelce-clock_recovery intelce-demux intelce-viddec intelce-vidpproc intelce-display intelce-vidrend intelce-bufmon intelce-gstreamer intelce-edl intelce-system_utils intelce-tsout intelce-idl intelce-avcap intelce-smd_avcap_shim intelce-remux intelce-vidsink intelce-videnc intelce-mux intelce-sec
...
define INTELCE_SMD_SAMPLE_APPS_BUILD_CMDS
    ...
    ${INTELCE_SMD_SAMPLE_APPS_BUILD_ENV} ${INTELSDK-BUILD} smd_sample_apps
endef

define INTELCE_SMD_SAMPLE_APPS_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_SMD_SAMPLE_APPS_DIR}/build_i686/staging_dir) 
endef

define INTELCE_SMD_SAMPLE_APPS_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_SMD_SAMPLE_APPS_DIR}/project_build_i686/IntelCE/root)
endef
