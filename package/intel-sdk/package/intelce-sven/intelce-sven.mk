...
#
################################################################################
INTELCE_SVEN_VERSION = ${INTEL_SDK_VERSION}
INTELCE_SVEN_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_SVEN_SITE_METHOD = local
INTELCE_SVEN_LICENSE = PROPRIETARY
INTELCE_SVEN_REDISTRIBUTE = NO
INTELCE_SVEN_DEPENDENCIES = intel-sdk linux intelce-htuple intelce-auto_eas intelce-osal intelce-pal intelce-platform_config intelce-SMD_Common intelce-iosf
...
define INTELCE_SVEN_BUILD_CMDS
    ...
    ${INTELCE_SVEN_BUILD_ENV} ${INTELSDK-BUILD} sven
endef

define INTELCE_SVEN_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_SVEN_DIR}/build_i686/staging_dir) 
endef

define INTELCE_SVEN_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_SVEN_DIR}/project_build_i686/IntelCE/root)
endef
