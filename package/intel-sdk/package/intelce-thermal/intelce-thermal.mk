...
#
################################################################################
INTELCE_THERMAL_VERSION = ${INTEL_SDK_VERSION}
INTELCE_THERMAL_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_THERMAL_SITE_METHOD = local
INTELCE_THERMAL_LICENSE = PROPRIETARY
INTELCE_THERMAL_REDISTRIBUTE = NO
INTELCE_THERMAL_DEPENDENCIES = intel-sdk linux intelce-osal intelce-pal
...
define INTELCE_THERMAL_BUILD_CMDS
    ...
    ${INTELCE_THERMAL_BUILD_ENV} ${INTELSDK-BUILD} thermal
endef

define INTELCE_THERMAL_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_THERMAL_DIR}/build_i686/staging_dir) 
endef

define INTELCE_THERMAL_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_THERMAL_DIR}/project_build_i686/IntelCE/root)
endef
