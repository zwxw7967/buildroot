...
#
################################################################################
INTELCE_TRANSCODER_COMMON_VERSION = ${INTEL_SDK_VERSION}
INTELCE_TRANSCODER_COMMON_SITE = ${INTEL_SDK_DIR}/empty
...
INTELCE_TRANSCODER_COMMON_DEPENDENCIES = intel-sdk linux intelce-api intelce-osal intelce-SMD_Common intelce-core
...
define INTELCE_TRANSCODER_COMMON_BUILD_CMDS
    ...
    ${INTELCE_TRANSCODER_COMMON_BUILD_ENV} ${INTELSDK-BUILD} transcoder_common
endef

define INTELCE_TRANSCODER_COMMON_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_TRANSCODER_COMMON_DIR}/build_i686/staging_dir) 
endef

define INTELCE_TRANSCODER_COMMON_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_TRANSCODER_COMMON_DIR}/project_build_i686/IntelCE/root)
endef
