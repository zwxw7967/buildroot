...
#
################################################################################
INTELCE_TRANSCODER_DEVICE_VERSION = ${INTEL_SDK_VERSION}
INTELCE_TRANSCODER_DEVICE_SITE = ${INTEL_SDK_DIR}/empty
...
INTELCE_TRANSCODER_DEVICE_DEPENDENCIES = intel-sdk linux intelce-api intelce-osal intelce-SMD_Common intelce-smd_tools intelce-core intelce-htuple intelce-system_utils intelce-transcoder_common intelce-sec intelce-keyrefresh intelce-platform_config
...
define INTELCE_TRANSCODER_DEVICE_BUILD_CMDS
    ...
    ${INTELCE_TRANSCODER_DEVICE_BUILD_ENV} ${INTELSDK-BUILD} transcoder_device
endef

define INTELCE_TRANSCODER_DEVICE_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_TRANSCODER_DEVICE_DIR}/build_i686/staging_dir) 
endef

define INTELCE_TRANSCODER_DEVICE_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_TRANSCODER_DEVICE_DIR}/project_build_i686/IntelCE/root)
endef
