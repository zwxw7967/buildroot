...
#
################################################################################
INTELCE_TRANSCODER_SERVER_VERSION = ${INTEL_SDK_VERSION}
INTELCE_TRANSCODER_SERVER_SITE = ${INTEL_SDK_DIR}/empty
...
INTELCE_TRANSCODER_SERVER_DEPENDENCIES = intel-sdk linux intelce-SMD_Common intelce-transcoder_common intelce-transcoder_pipeline
...
define INTELCE_TRANSCODER_SERVER_BUILD_CMDS
    ...
    ${INTELCE_TRANSCODER_SERVER_BUILD_ENV} ${INTELSDK-BUILD} transcoder_server
endef

define INTELCE_TRANSCODER_SERVER_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_TRANSCODER_SERVER_DIR}/build_i686/staging_dir) 
endef

define INTELCE_TRANSCODER_SERVER_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_TRANSCODER_SERVER_DIR}/project_build_i686/IntelCE/root)
endef
