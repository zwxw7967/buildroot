...
#
################################################################################
INTELCE_VIDEO_CES_VERSION = ${INTEL_SDK_VERSION}
INTELCE_VIDEO_CES_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_VIDEO_CES_SITE_METHOD = local
INTELCE_VIDEO_CES_LICENSE = PROPRIETARY
INTELCE_VIDEO_CES_REDISTRIBUTE = NO
INTELCE_VIDEO_CES_DEPENDENCIES = intel-sdk intelce-system_utils intelce-pal intelce-auto_eas intelce-osal intelce-htuple intelce-common intelce-smd_tools intelce-sven linux intelce-core intelce-SMD_Common intelce-api intelce-platform_config intelce-intel_ce_pm intelce-sec intelce-fw_load
...
define INTELCE_VIDEO_CES_BUILD_CMDS
    ...
    ${INTELCE_VIDEO_CES_BUILD_ENV} ${INTELSDK-BUILD} video_ces
endef

define INTELCE_VIDEO_CES_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_VIDEO_CES_DIR}/build_i686/staging_dir) 
endef

define INTELCE_VIDEO_CES_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_VIDEO_CES_DIR}/project_build_i686/IntelCE/root)
endef
