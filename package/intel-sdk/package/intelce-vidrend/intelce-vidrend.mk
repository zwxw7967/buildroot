...
#
################################################################################
INTELCE_VIDREND_VERSION = ${INTEL_SDK_VERSION}
INTELCE_VIDREND_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_VIDREND_SITE_METHOD = local
INTELCE_VIDREND_LICENSE = PROPRIETARY
INTELCE_VIDREND_REDISTRIBUTE = NO
INTELCE_VIDREND_DEPENDENCIES = intel-sdk intelce-system_utils intelce-api intelce-pal intelce-auto_eas intelce-osal intelce-htuple intelce-platform_config intelce-common intelce-smd_tools intelce-sven linux intelce-core intelce-clock intelce-display intelce-SMD_Common intelce-vidpproc
...
define INTELCE_VIDREND_BUILD_CMDS
    ...
    ${INTELCE_VIDREND_BUILD_ENV} ${INTELSDK-BUILD} vidrend
endef

define INTELCE_VIDREND_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_VIDREND_DIR}/build_i686/staging_dir) 
endef

define INTELCE_VIDREND_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_VIDREND_DIR}/project_build_i686/IntelCE/root)
endef
