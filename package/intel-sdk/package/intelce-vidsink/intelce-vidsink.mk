...
#
################################################################################
INTELCE_VIDSINK_VERSION = ${INTEL_SDK_VERSION}
INTELCE_VIDSINK_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_VIDSINK_SITE_METHOD = local
INTELCE_VIDSINK_LICENSE = PROPRIETARY
INTELCE_VIDSINK_REDISTRIBUTE = NO
INTELCE_VIDSINK_DEPENDENCIES = intel-sdk intelce-system_utils intelce-api intelce-core intelce-osal intelce-auto_eas intelce-sven intelce-smd_tools intelce-common linux intelce-SMD_Common intelce-vidrend intelce-vidpproc
...
define INTELCE_VIDSINK_BUILD_CMDS
    ...
    ${INTELCE_VIDSINK_BUILD_ENV} ${INTELSDK-BUILD} vidsink
endef

define INTELCE_VIDSINK_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_VIDSINK_DIR}/build_i686/staging_dir) 
endef

define INTELCE_VIDSINK_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_VIDSINK_DIR}/project_build_i686/IntelCE/root)
endef
