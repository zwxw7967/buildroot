...
#
################################################################################
INTELCE_WATCHDOG_VERSION = ${INTEL_SDK_VERSION}
INTELCE_WATCHDOG_SITE = ${INTEL_SDK_DIR}/empty
INTELCE_WATCHDOG_SITE_METHOD = local
INTELCE_WATCHDOG_LICENSE = PROPRIETARY
INTELCE_WATCHDOG_REDISTRIBUTE = NO
INTELCE_WATCHDOG_DEPENDENCIES = intel-sdk
...
define INTELCE_WATCHDOG_BUILD_CMDS
    ...
    ${INTELCE_WATCHDOG_BUILD_ENV} ${INTELSDK-BUILD} watchdog
endef

define INTELCE_WATCHDOG_INSTALL_STAGING_CMDS
    $(call INTEL_SDK_INSTALL_TO_STAGING,${INTELCE_WATCHDOG_DIR}/build_i686/staging_dir) 
endef

define INTELCE_WATCHDOG_INSTALL_TARGET_CMDS
    $(call INTEL_SDK_INSTALL_TO_TARGET,${INTELCE_WATCHDOG_DIR}/project_build_i686/IntelCE/root)
endef
