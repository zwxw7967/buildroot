...
INTELCE_SMD_COMMON_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_SMD_COMMON_BUILD_CMDS
    ...
    ${INTELCE_SMD_COMMON_BUILD_ENV} ${INTELCESDK-BUILD} SMD_Common
endef

define INTELCE_SMD_COMMON_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_SMD_COMMON_DIR}/build_i686/staging_dir) 
endef

define INTELCE_SMD_COMMON_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_SMD_COMMON_DIR}/project_build_i686/IntelCE/root)
endef
