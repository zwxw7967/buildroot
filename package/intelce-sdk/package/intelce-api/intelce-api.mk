...
INTELCE_API_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_API_BUILD_CMDS
	...
	${INTELCE_API_BUILD_ENV} ${INTELCESDK-BUILD} api
endef

define INTELCE_API_INSTALL_STAGING_CMDS
	$(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_API_DIR}/build_i686/staging_dir) 
endef

define INTELCE_API_INSTALL_TARGET_CMDS
	$(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_API_DIR}/project_build_i686/IntelCE/root)
endef
