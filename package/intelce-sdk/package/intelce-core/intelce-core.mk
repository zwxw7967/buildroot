...
INTELCE_CORE_SITE = ${INTELCE_SDK_DIR}/empty
INTELCE_CORE_SITE_METHOD = local
INTELCE_CORE_LICENSE = PROPRIETARY
INTELCE_CORE_REDISTRIBUTE = NO
INTELCE_CORE_DEPENDENCIES = intelce-sdk intelce-system_utils intelce-pal intelce-platform_config intelce-auto_eas intelce-osal intelce-htuple intelce-smd_tools intelce-sven linux intelce-SMD_Common intelce-api intelce-platform_config intelce-intel_ce_pm
...
define INTELCE_CORE_BUILD_CMDS
    ...
    ${INTELCE_CORE_BUILD_ENV} ${INTELCESDK-BUILD} core
endef

define INTELCE_CORE_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_CORE_DIR}/build_i686/staging_dir) 
endef

define INTELCE_CORE_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_CORE_DIR}/project_build_i686/IntelCE/root)
endef
