...
INTELCE_GENERIC_TIMER_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_GENERIC_TIMER_BUILD_CMDS
    ...
    ${INTELCE_GENERIC_TIMER_BUILD_ENV} ${INTELCESDK-BUILD} generic_timer
endef

define INTELCE_GENERIC_TIMER_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_GENERIC_TIMER_DIR}/build_i686/staging_dir) 
endef

define INTELCE_GENERIC_TIMER_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_GENERIC_TIMER_DIR}/project_build_i686/IntelCE/root)
endef
