...
INTELCE_ITSTORE_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_ITSTORE_BUILD_CMDS
    ...
    ${INTELCE_ITSTORE_BUILD_ENV} ${INTELCESDK-BUILD} itstore
endef

define INTELCE_ITSTORE_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_ITSTORE_DIR}/build_i686/staging_dir) 
endef

define INTELCE_ITSTORE_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_ITSTORE_DIR}/project_build_i686/IntelCE/root)
endef
