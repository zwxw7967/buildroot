...
INTELCE_PIC24_UART_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_PIC24_UART_BUILD_CMDS
    ...
    ${INTELCE_PIC24_UART_BUILD_ENV} ${INTELCESDK-BUILD} pic24_uart
endef

define INTELCE_PIC24_UART_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_PIC24_UART_DIR}/build_i686/staging_dir) 
endef

define INTELCE_PIC24_UART_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_PIC24_UART_DIR}/project_build_i686/IntelCE/root)
endef
