...
INTELCE_PIC24_UART_DRV_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_PIC24_UART_DRV_BUILD_CMDS
    ...
    ${INTELCE_PIC24_UART_DRV_BUILD_ENV} ${INTELCESDK-BUILD} pic24_uart_drv
endef

define INTELCE_PIC24_UART_DRV_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_PIC24_UART_DRV_DIR}/build_i686/staging_dir) 
endef

define INTELCE_PIC24_UART_DRV_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_PIC24_UART_DRV_DIR}/project_build_i686/IntelCE/root)
endef
