...
INTELCE_PLATFORM_CONFIG_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_PLATFORM_CONFIG_BUILD_CMDS
    ...
    ${INTELCE_PLATFORM_CONFIG_BUILD_ENV} ${INTELCESDK-BUILD} platform_config
endef

define INTELCE_PLATFORM_CONFIG_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_PLATFORM_CONFIG_DIR}/build_i686/staging_dir) 
endef

define INTELCE_PLATFORM_CONFIG_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_PLATFORM_CONFIG_DIR}/project_build_i686/IntelCE/root)
endef
