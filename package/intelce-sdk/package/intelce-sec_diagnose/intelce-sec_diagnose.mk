...
INTELCE_SEC_DIAGNOSE_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_SEC_DIAGNOSE_BUILD_CMDS
    ...
    ${INTELCE_SEC_DIAGNOSE_BUILD_ENV} ${INTELCESDK-BUILD} sec_diagnose
endef

define INTELCE_SEC_DIAGNOSE_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_SEC_DIAGNOSE_DIR}/build_i686/staging_dir) 
endef

define INTELCE_SEC_DIAGNOSE_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_SEC_DIAGNOSE_DIR}/project_build_i686/IntelCE/root)
endef
