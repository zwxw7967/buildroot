...
INTELCE_SMD_AVCAP_SHIM_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_SMD_AVCAP_SHIM_BUILD_CMDS
    ...
    ${INTELCE_SMD_AVCAP_SHIM_BUILD_ENV} ${INTELCESDK-BUILD} smd_avcap_shim
endef

define INTELCE_SMD_AVCAP_SHIM_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_SMD_AVCAP_SHIM_DIR}/build_i686/staging_dir) 
endef

define INTELCE_SMD_AVCAP_SHIM_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_SMD_AVCAP_SHIM_DIR}/project_build_i686/IntelCE/root)
endef
