...
INTELCE_SYSTEM_UTILS_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_SYSTEM_UTILS_BUILD_CMDS
    ...
    ${INTELCE_SYSTEM_UTILS_BUILD_ENV} ${INTELCESDK-BUILD} system_utils
endef

define INTELCE_SYSTEM_UTILS_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_SYSTEM_UTILS_DIR}/build_i686/staging_dir) 
endef

define INTELCE_SYSTEM_UTILS_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_SYSTEM_UTILS_DIR}/project_build_i686/IntelCE/root)
endef
