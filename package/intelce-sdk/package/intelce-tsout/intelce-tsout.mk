...
INTELCE_TSOUT_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_TSOUT_BUILD_CMDS
    ...
    ${INTELCE_TSOUT_BUILD_ENV} ${INTELCESDK-BUILD} tsout
endef

define INTELCE_TSOUT_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_TSOUT_DIR}/build_i686/staging_dir) 
endef

define INTELCE_TSOUT_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_TSOUT_DIR}/project_build_i686/IntelCE/root)
endef
