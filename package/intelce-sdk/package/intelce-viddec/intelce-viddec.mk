...
INTELCE_VIDDEC_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_VIDDEC_BUILD_CMDS
    ...
    ${INTELCE_VIDDEC_BUILD_ENV} ${INTELCESDK-BUILD} viddec
endef

define INTELCE_VIDDEC_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_VIDDEC_DIR}/build_i686/staging_dir) 
endef

define INTELCE_VIDDEC_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_VIDDEC_DIR}/project_build_i686/IntelCE/root)
endef
