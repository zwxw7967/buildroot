...
INTELCE_VIDENC_SITE = ${INTELCE_SDK_DIR}/empty
...
define INTELCE_VIDENC_BUILD_CMDS
    ...
    ${INTELCE_VIDENC_BUILD_ENV} ${INTELCESDK-BUILD} videnc
endef

define INTELCE_VIDENC_INSTALL_STAGING_CMDS
    $(call INTELCE_SDK_INSTALL_TO_STAGING,${INTELCE_VIDENC_DIR}/build_i686/staging_dir) 
endef

define INTELCE_VIDENC_INSTALL_TARGET_CMDS
    $(call INTELCE_SDK_INSTALL_TO_TARGET,${INTELCE_VIDENC_DIR}/project_build_i686/IntelCE/root)
endef
