...
NETFLIX_VERSION = 678dab94701fc9fc3a9b094b3e4bb75cf1682ff9
...
NETFLIX_CONF_OPTS += \
	-DCMAKE_C_FLAGS_DEBUG="$(NETFLIX_CFLAGS)" \
	-DCMAKE_CXX_FLAGS_DEBUG="$(NETFLIX_CXXFLAGS)" \
	-DCMAKE_C_FLAGS_RELEASE="$(NETFLIX_CFLAGS)" \
	-DCMAKE_CXX_FLAGS_RELEASE="$(NETFLIX_CXXFLAGS)" \
	-DCMAKE_CXX_FLAGS="$(NETFLIX_CFLAGS)"\
	-DCMAKE_C_FLAGS="$(NETFLIX_CXXFLAGS)"
