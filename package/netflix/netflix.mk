...
NETFLIX_CONF_OPTS += \
	...
	-DCMAKE_C_FLAGS_DEBUG="$(shell echo $(TARGET_CFLAGS) | sed 's/-O[0-9]/-O0/g') -fno-inline -ggdb3" \
	-DCMAKE_CXX_FLAGS_DEBUG="$(shell echo $(TARGET_CFLAGS) | sed 's/-O[0-9]/-O0/g') -fno-inline -ggdb3"
else
NETFLIX_CONF_OPTS += \
