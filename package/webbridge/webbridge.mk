...
WEBBRIDGE_VERSION = 7ce81b7f6bc52813f483e66ebcd371e131b4a657
...
ifeq ($(BR2_PACKAGE_PLUGIN_HORIZONCOMMUNICATOR),y)
WEBBRIDGE_CONF_OPTS += -DWEBBRIDGE_PLUGIN_HORIZONCOMMUNICATOR=ON
endif

ifeq ($(BR2_PACKAGE_WEBBRIDGE_TESTMQC),y)
WEBBRIDGE_CONF_OPTS += -DWEBBRIDGE_TESTS=ON
WEBBRIDGE_CONF_OPTS += -DWEBBRIDGE_TEST_MQCTESTCLIENT=ON
endif
